        ...
        <Wrapper>
            ...
            <CardsGrid>
                ...
                <StatCard bg="#fff4e5" color="#ea580c">
                    <Label>
                        <FaClock /> Avg Response Time
                    </Label>
                    <Value>
                        <CountUp
                            end={stats.avgResponseTime}
                            duration={1.5}
                            suffix="ms"
                        />
                    </Value>
                ...
                <StatCard bg="#f6f0ff" color="#9333ea">
                    <Label>
                        <FaExclamationCircle /> Today's Calls
                    </Label>
                    <Value>
                        <CountUp end={stats.today} duration={1.5} />
                    </Value>
                </StatCard>
            </CardsGrid>
        </Wrapper>
